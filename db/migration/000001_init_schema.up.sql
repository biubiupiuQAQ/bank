...
CREATE INDEX `transfers_index_3` ON `transfers` (`to_accout_id`);

CREATE INDEX `transfers_index_4` ON `transfers` (`from_account_id`, `to_accout_id`);
...
ALTER TABLE `transfers` ADD FOREIGN KEY (`to_accout_id`) REFERENCES `account` (`id`)
